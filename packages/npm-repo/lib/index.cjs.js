...
var core = require('@vuex-orm/core');

/**
 * Created by Jaron Long on 2019/11/19
 */
let ChatModel = /** @class */ (() => {
    class ChatModel extends core.Model {
        static fields() {
            return {
                // chatId or deviceId
...
exports.ChatCrmModel = ChatCrmModel;
exports.ChatModel = ChatModel;
exports.initializeChat = initialize;
exports.initializeChatCrmModel = initialize$1;
